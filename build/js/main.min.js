...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var headers = document.querySelectorAll('.price__title-wrapper');
  function changeHeight(items, adaptive) {
    ...
    if (adaptive) {
      ...
      items.forEach(function (item) {
        var itemHeight = item.offsetHeight;
        if (itemHeight > _maxHeight) {
          _maxHeight = itemHeight;
        }
      });
      items.forEach(function (item) {
        item.style.height = "".concat(_maxHeight, "px");
      });
    }
  }
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13,"./vendor/swiper":15}],2:[function(require,module,exports){
"use strict";
